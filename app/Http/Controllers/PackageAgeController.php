...
class PackageAgeController extends Controller
{
    ...
    public function GetData($idCompany, $states, $routes, $status, $typeData) 
    {
        if($status == 'all')
        {
            ...
            $idsPackageLmCarrier = PackageHistory::where('status', '=', 'LM Carrier')->get('Reference_Number_1');
        ...
        {
            $idsAll = PackageHistory::where('status', '=', 'LM Carrier')->get('Reference_Number_1');
        }
    ...
    public function GetStatus($Reference_Number_1)
    {
        ...
        $package = $package != null ? $package : PackageHistory::where('status', '=', 'LM Carrier')->find($Reference_Number_1);

    ...
    {        
        ...
        if(!$packageHistory)
        {
            try
            {
                ...
                $Reference_Number_1 = 'OCC'. strtotime(date('Y-m-d H:i:s'));
                ...
                $package->Reference_Number_1           = $Reference_Number_1;
                ...
                $package->quantity                     = $request->get('quantity');
                ...
                $packageHistory->Reference_Number_1           = $Reference_Number_1;
                ...
                $packageHistory->quantity                     = $request->get('quantity');
                $packageHistory->created_at                   = $created_at;
                $packageHistory->updated_at                   = $created_at;
                $packageHistory->save();

                $packageNotExists = PackageNotExists::find($Reference_Number_1);

...
export default PackageDispatchDriver;

// DOM element
if (document.getElementById('packageDispatchDriver')) {
    ReactDOM.render(<PackageDispatchDriver />, document.getElementById('packageDispatchDriver'));
}
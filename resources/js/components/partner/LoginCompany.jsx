...
function LoginCompany() {
    ...
    const handlerSubmit = (e) => {
        ...
        fetch(url_general +'partners/login', {
                  ...
                  <div className="card mb-3">
                    ...
                    <div className="card-body">
                      ...
                      <div className="pt-4 pb-2">
                        ...
                        <a href="./package-check" className="text-success">Go to Check Stoprer</a>
                    </div>
                  </div>
...
// DOM element
if (document.getElementById('login-company')) {
    ReactDOM.render(<LoginCompany />, document.getElementById('login-company'));
}

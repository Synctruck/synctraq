...
function ReportPartnerManifest() {
    ...
    const listReportManifest = (pageNumber, routeSearch, stateSearch) => {
        ...
        fetch(url_general +'partners/report/list/manifest/'+ dateInit +'/'+ dateEnd +'/'+ routeSearch +'/'+ stateSearch +'?page='+ pageNumber)
        .then(res => res.json())
        .then((response) => {
    ...
    const handlerExport = () => {
        ...
        if(difference> limitToExport){
            ...
            location.href = url_general +'partners/report/export/manifest/'+ dateInit +'/'+ dateEnd +'/'+ RouteSearch +'/'+ StateSearch;
        }
    }
...
export default ReportPartnerManifest;

if (document.getElementById('reportPartnerManifest'))
{
    ReactDOM.render(<ReportPartnerManifest />, document.getElementById('reportPartnerManifest'));
}

...
function PackageRts() {
    ...
    const listReturnCompany = (pageNumber, routeSearch, stateSearch) => {
        ...
        fetch(url_general +'package-pre-rts/list/'+ dateInit +'/'+ dateEnd +'/'+ routeSearch +'/'+ stateSearch +'?page='+ pageNumber)
        .then(res => res.json())
        .then((response) => {
    ...
    const handlerInsert = (e) => {
        ...
        let url = 'package-pre-rts/insert'
        ...
        then((response) => {
                ...
                {
                    swal('Packet does not exist in Inbound or Warehouse or Dispatch!', {
    ...
    const handlerOpenModal = (viewForm) => {
    ...
    const formInsertReturn =    <React.Fragment>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-3">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="NUMBER" value={ weight } className="form-control" step="0.01" onChange={ (e) => setWeight(e.target.value) } required/>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="NUMBER" value={ width } className="form-control" step="0.01" onChange={ (e) => setWidth(e.target.value) } required/>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="NUMBER" value={ length } className="form-control" step="0.01" onChange={ (e) => setLength(e.target.value) } required/>
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-3">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="NUMBER" value={ height } className="form-control" step="0.01" onChange={ (e) => setHeight(e.target.value) } required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <h5 className="card-title">
                                <div className="row form-group">
                                    <div className="col-lg-3 mb-3">
                                        <button className="btn btn-primary form-control" onClick={ () => handlerExport() }><i className="ri-file-excel-fill"></i> Export</button>
                                    </div>
                                    <div className="col-lg-3 mb-3">
                                        <button className="btn btn-danger form-control" onClick={ () => handlerOpenModal(viewForm) }> Return</button>
                                    </div>
                                    <div className="col-lg-12 mb-3" style={ {display: viewForm}}>
                                        { formInsertReturn }
                                    </div>

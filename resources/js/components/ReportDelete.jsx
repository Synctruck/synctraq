...
function ReportDelete() {
    ...
    const listReportDispatch = async (pageNumber, routeSearch, stateSearch) => {
        ...
        const responseData = await fetch(url_general +'report/list/delete/'+ idCompany +'/'+ dateInit +'/'+ dateEnd +'/'+ idTeam +'/'+ idDriver +'/'+ routeSearch +'/'+ stateSearch +'/'+ statusDescription +'?page='+ pageNumber)
        .then(res =>  res.json())
        .then((response) => {
    ...
    const handlerExport = (type) => {
        ...
        {
            let url = url_general +'report/export/delete/'+ idCompany +'/'+ dateInit +'/'+ dateEnd +'/'+ idTeam +'/'+ idDriver +'/'+ RouteSearch +'/'+ StateSearch +'/'+ statusDescription +'/'+ type;
...
if (document.getElementById('reportDelete'))
{
    ReactDOM.render(<ReportDelete />, document.getElementById('reportDelete'));
}

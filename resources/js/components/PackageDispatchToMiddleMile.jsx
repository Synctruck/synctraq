...
function PackageDispatchToMiddleMile() {
    ...
    const listAllPackageInbound = (pageNumber, route, state) => {
        ...
        fetch(url_general +'package-dispatch-to-middlemile/list/'+ idCompany +'/'+ dateStart+'/'+ dateEnd +'/'+ route +'/'+ state +'/?page='+ pageNumber)
        .then(res => res.json())
        .then((response) => {
    ...
    const exportAllPackageInbound = (route, state, type) => {
        ...
        let url = url_general +'package-dispatch-to-middlemile/export/'+idCompany+'/'+ dateStart+'/'+ dateEnd +'/'+ route +'/'+ state +'/'+type;
    ...
    const handlerOpenModal = (PACKAGE_ID) => {
        ...
        fetch(url_general +'package-dispatch-to-middlemile/get/'+ PACKAGE_ID)
        .then(res => res.json())
        .then((response) => {
    ...
    const handlerUpdatePackage = (e) => {
        ...
        let url = 'package-dispatch-to-middlemile/update'
    ...
    const handlerImport = (e) => {
        ...
        fetch(url_general +'package-dispatch-to-middlemile/import', {
            headers: { "X-CSRF-TOKEN": token },
            method: 'post',
            body: formData
        })
    ...
    const handlerInsert = (e) => {
        ...
        if(sendInbound)
        {
            ...
            if(latitude !=0 && longitude != 0)
            {
                ...
                fetch(url_general +'package-dispatch-to-middlemile/send-pallet', {
                    headers: { "X-CSRF-TOKEN": token },
                    method: 'post',
                    body: formData
                })
                                    ...
                                    <div className="col-lg-2" style={ {paddingLeft: (isLoading ? '5%' : '')} }>
                                        {
                                            (
                                                ...
                                                :
                                                <b className="alert-success" style={{ borderRadius: '5px', padding: '5px', fontSize: '12px' }}>
...
export default PackageDispatchToMiddleMile;

// DOM element
if (document.getElementById('packageDispatchToMiddleMile')) {
    ReactDOM.render(<PackageDispatchToMiddleMile />, document.getElementById('packageDispatchToMiddleMile'));
}
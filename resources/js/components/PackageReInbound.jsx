...
function PackageReInbound() {
    ...
    const listAllPackageInbound = (pageNumber, dataView, route, state) => {
        ...
        fetch(url_general +'package-re-inbound/list/'+ dataView +'/'+ route +'/'+ state +'/?page='+ pageNumber)
        .then(res => res.json())
        .then((response) => {
    ...
    const listAllClient = () => {
        ...
        fetch(url_general +'client/getAll')
        .then(res => res.json())
        .then((response) => {

            setListClient(response.clientList);
        });
    }
    ...
    const handlerInsert = (e) => {
        ...
        .then((response) => {
                ...
                {
                    setTextMessage("VALID #"+ Reference_Number_1);
    ...
    const optionClient = listClient.map( (client, i) => {
...
export default PackageReInbound;

// DOM element
if(document.getElementById('packageReinbound'))
{
    ReactDOM.render(<PackageReInbound />, document.getElementById('packageReinbound'));
}

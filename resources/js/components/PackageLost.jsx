...
function PackageLost() {
    ...
    const listAllPackageInbound = (pageNumber, route, state) => {
        ...
        fetch(url_general +'package-lost/list/'+ idCompany +'/'+ dateStart+'/'+ dateEnd +'/'+ route +'/'+ state +'/?page='+ pageNumber)
        .then(res => res.json())
        .then((response) => {
    ...
    const handlerOpenModal = (PACKAGE_ID) => {
        ...
        fetch(url_general +'package-lost/get/'+ PACKAGE_ID)
        .then(res => res.json())
        .then((response) => {
    ...
    const handlerImport = (e) => {
        ...
        fetch(url_general +'package-lost/import', {
            headers: { "X-CSRF-TOKEN": token },
            method: 'post',
            body: formData
        })
...
export default PackageLost;

// DOM element
if (document.getElementById('packageLost')) {
    ReactDOM.render(<PackageLost />, document.getElementById('packageLost'));
}

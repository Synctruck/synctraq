...
<div className="col-12 mt-2 tracking-details  d-block d-sm-none">
  <div className="row">
    <div className="col-md-3">
      <Steps current={step === 0 ? 0 : 1} showNumber={false} className="text-center">
    ...
    <div className="col-md-3">
      <Steps current={step === 2 ? 0 : 1} showNumber={false} className="text-center">
        <Steps.Item title="Out for Delivery" />
      </Steps>
    </div>
    <div className="col-md-3">
      <Steps current={step === 3 ? 0 : 1} showNumber={false} className="text-center">
